...
// We Create a third title layer that will be the backround of opur map.
...
let majorEarthquaes = new L.LayerGroup();

// 2. Add a reference to the major earthquake group to the overlays object.
let overlays = {
  "Earthquakes": allEarthquakes,
  "Tetctonic plates": tectonicPlates,
  "Major Earthquakes": majorEarthquaes
};
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson").then(function(data) {
  ...
  }).addTo(majorEarthquaes);
  // 8. Add the major earthquakes layer to the map.
  majorEarthquaes.addTo(map)
